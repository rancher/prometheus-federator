...
type Interface interface {
	...
	PodMonitor() PodMonitorController
	Prometheus() PrometheusController
	PrometheusRule() PrometheusRuleController
}
...
func (c *version) PodMonitor() PodMonitorController {
	return NewPodMonitorController(schema.GroupVersionKind{Group: "monitoring.coreos.com", Version: "v1", Kind: "PodMonitor"}, "podmonitors", true, c.controllerFactory)
}
...
func (c *version) PrometheusRule() PrometheusRuleController {
	return NewPrometheusRuleController(schema.GroupVersionKind{Group: "monitoring.coreos.com", Version: "v1", Kind: "PrometheusRule"}, "prometheusrules", true, c.controllerFactory)
}
