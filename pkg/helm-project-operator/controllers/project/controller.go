...
func (h *handler) OnChange(projectHelmChart *v1alpha2.ProjectHelmChart, projectHelmChartStatus v1alpha2.ProjectHelmChartStatus) ([]runtime.Object, v1alpha2.ProjectHelmChartStatus, error) {
	...
	if !shouldManage {
		logrus.Infof("Cancelled handling of ProjectHelmChart %s. shouldManage returned 'false'.", projectHelmChart.Name, projectHelmChart.Namespace)
		return nil, projectHelmChartStatus, nil
	}
	if projectHelmChart.DeletionTimestamp != nil {
		logrus.Infof("Cancelled handling of ProjectHelmChart %s. CR has been deleted.", projectHelmChart.Name, projectHelmChart.Namespace)
		return nil, projectHelmChartStatus, nil
	}
