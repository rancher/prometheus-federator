...
#   PF_DIR      - path to prometheus-federator workspace ($GITHUB_WORKSPACE)
...
export PF_DIR CHARTS_DIR DRY_RUN
...
# --- Check code freeze ---
FREEZE_MANIFEST="/tmp/pf-push/code-freeze.yaml"
...
export SOURCE_REPO="${SOURCE_REPO:-rancher/prometheus-federator}"
