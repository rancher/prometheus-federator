...
#
# Usage:
#   ./run-local.sh --charts-dir /path/to/rancher/charts --tag v7.0.1-rc.2 [OPTIONS]
#
# Options:
#   --charts-dir DIR    Path to local rancher/charts clone (required)
#   --tag TAG           prometheus-federator release tag to process (e.g. v7.0.1-rc.2) (required)
#   --remote NAME       Remote name for rancher/charts in CHARTS_DIR (default: origin)
#   --source-repo REPO  Source repo for PR body (default: rancher/prometheus-federator)
...
TAG=""
SOURCE_REPO="rancher/prometheus-federator"
...
export TAG TARGET_BRANCH CHARTS_DIR CHARTS_REMOTE DRY_RUN PF_DIR SOURCE_REPO
